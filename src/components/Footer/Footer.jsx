      ...
      <div className='footer-container'>
        <div className='grid grid-cols-2 text-gray-400 md:grid-cols-6 pt-10 md:pt-25'>
          <div className='col-span-2 flex flex-col p-5 md:p-10'>
            <p className='font-bold text-2xl'>Job Finder</p>
          ...
          <div className='col-span-1 flex flex-col p-3 md:p-5'>
            ...
            <p className='my-1 text-xs font-thin'>111 CYstreet , NYC</p>
            <p className='my-1 text-xs font-thin'>+1 123 - 978 - 5570</p>
          </div>
        </div>
        ...
        <div className='text-gray-300 p-5 md:p-10 flex justify-between items-center'>
          <p className='text-[0.5rem]'>@2023 Job Finder. All Rights Reserved</p>
          <p className='text-[0.5rem]'>Powered by Sakib Iqbal</p>
        </div>
      </div>
    </div>
  );
